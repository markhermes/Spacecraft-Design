...
[t,y]   = ode45(@(t,x) orbital_sim_with_coarse_control(t,x,ge,Ib,Ib_inv,DT),tspan,ic,opts);
...
% get the applied torques and the angular error
[err,tau]     = get_coarse_control_torques(q_fsn,q_body,w_body,Ib,DT);
